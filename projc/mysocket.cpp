...
#include "aes-test.h"
/*********************************************************************************************
 * mysocket.cpp: added function compute_tcp_checksum, copied from:
...
int CSocket::send_tcp_rawsock(struct sockaddr_in src_addr, struct sockaddr_in dst_addr1, char* org_packet, int len)
{
    ...
    */
    ...
    {
	if((unsigned int) p->psh == 1)
    	{
		printf("inside: len is %d \n",len);
		//p->doff = sizeof(struct tcphdr)/4;
		iov.iov_base = org_packet;
		iov.iov_len = len;
...
/*********************************************************************************************
 * compute_tcp_checksum: added function compute_tcp_checksum, copied from:
 * http://www.roman10.net/2011/11/27/how-to-calculate-iptcpudp-checksumpart-2-implementation/
 *********************************************************************************************/
